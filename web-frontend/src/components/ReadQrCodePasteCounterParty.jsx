...
const ReadQrCodePasteCounterParty = () => {
    ...
    return (
        <div style={{display:'flex', justifyContent:'center', alignItems:'center', fontSize:'5vh', zIndex:'99999', color:'#fff', position:'absolute', height:'100%', width:'100%', top:'0',left:'0',}}>
            <div style={{textAlign:'center', position:'absolute', width:'100%',height:'100%',}}>
                <div onClick={()=>{setshowCounterPartyScanner(!showCounterPartyScanner)}} style={{cursor:'pointer', transform:'scale(1.5)', zIndex:'9999',position:'absolute',top:'-1vh',right:'3%',}}>
                    <CancelIcon />
                </div>
                ...
                <QrReader
                    ...
                    if (!!result) {
                        setcounterPartyAddress(result?.text);
                        setshowCounterPartyScanner(!showCounterPartyScanner);
                    }
...
export default ReadQrCodePasteCounterParty 