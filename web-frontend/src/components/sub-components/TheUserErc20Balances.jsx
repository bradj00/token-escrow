        ...
        <div style={{position:'absolute',top:'16vh',width:'99%'}}>
            ...
            {props.userErc20TokenBalance? 
                props.userErc20TokenBalance.map((item, index)=>{
                    return(
                        <div key={index} className="selectATokenEntry" onClick={()=>{console.log(item.symbol)}} style={{cursor:'pointer',display:'flex', alignItems:'center', fontSize:'3vh',position:'relative',width:'100%',height:'6vh',marginTop:'0.5vh',marginBottom:'0.5vh',left:'0.5vw'}}>
